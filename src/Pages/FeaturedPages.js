  ...
  return (
    ...
    <main style={{ backgroundColor: 'rgb(251, 245, 235)' }}>
      ...
      <h2>Featured Pets</h2>
        <div className="pet-cards">
          ...
          <div className="pet-card">
            ...
            alt="Featured Pet 1" /></a>
            <h3>Dogs</h3>
            <a href="adoptdog" className="adopt-btn">Adopt Dog</a>
          </div>
          ...
          <div className="pet-card">
            <a href="adopt"><img
             ...
             alt="Featured Pet 2" /></a>
            <h3>Cats</h3>
            <a href="adoptcat" className="adopt-btn">Adopt Cat</a>
          </div>
          ...
          <div className="pet-card">
            <a href="adopt"><img
             ...
             alt="Featured Pet 3" /></a>
            <h3>Birds</h3>
            <a href="adoptBirds" className="adopt-btn">Adopt Birds</a>
          </div>
      ...
      <section className="pet-care-products">
        <h2 style={{textAlign:"center",marginBottom:"3%"}}>Pet Care Products</h2>
